...
let g:vim_bootstrap_langs = "c,elixir,erlang,html,javascript,lisp,php,python,rust,typescript"
...
nnoremap <C-]> :vsp <CR>:exec("tag ".expand("<cword>"))<CR>zz
